...
//*******************
// 						MANDELBROAT CALC ASYNC.JS
//*******************

function mandelbroat_calc_asyncjs(starth,stoph)
{
		...
		function(next_i) // DO
		{
			...
			async.doWhilst(
				function(next_j) // DO
				{
				  ...
				  setTimeout(function() { next_j(null, iY); }, 0);
				},function() { return ++iX < iXmax; } // WHILE ( J<5 )	
				
			)	
		
		},function() { return ++iY < iYmax; } // WHILE ( I<5 )

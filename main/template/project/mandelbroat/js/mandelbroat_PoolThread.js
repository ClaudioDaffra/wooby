...
function mandelbroat_calc_poolthread(starth,stoph)
{
	...
	var iY = starth;
	// ASYNC WHILE ( iY < iYmax )
	loop
	(
	starth, function(iY){return iY<iYmax;}, function(iY){return ++iY;},
	  function(iY, next)
	  {
		if ( iY < iYmax )
		{ 
			...
			// ASYNC WHILE ( iX < iXmax )
			loop(0, function(iX){return iX<iXmax;}, function(iX){return ++iX;},
			  function(iX, next)
			  {
				if ( iX < iXmax )
				{

...
(function ($) 
{
    ...
    wb.parallel.php = function (anyNumberOfWorkers, allDoneCallback) 
	{
...
(
	function (callback) 
	{ 
		$.post("math.pow.php", {n:3}, callback, "json"); 
	},
	function (callback) 
	{ 
		$.post("file.write.php", {fname:'claudio.txt',farg:'w',fdata:'ciao'}, callback, "json"); 
	},		  
	function (d1,d2) 
	{ 
		// Handle success; each argument to this function is 
